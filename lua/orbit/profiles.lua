...
local function validate_profile(profile)
  ...
  if not valid then
	...
	if profile.kind ~= "trino" and profile.kind ~= "sqlite" and profile.kind ~= "postgres" and profile.kind ~= "vertica" and profile.kind ~= "mysql" and profile.kind ~= "mssql" and profile.kind ~= "redis" then
